  ...
  return (
    <div className="content-layer flex h-full flex-col p-4 sm:p-7">
      <div>
        ...
        <p className="mt-2 text-xs leading-5 text-muted sm:text-sm sm:leading-6">Need a website, SaaS platform, dashboard or custom web application? Start the conversation here.</p>
      </div>
