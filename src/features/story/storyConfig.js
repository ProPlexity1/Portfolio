...
export const glassShards = [
  ...
  { x: 166, y: -142, rotate: 22, clip: 'polygon(66% 0, 100% 0, 100% 49%, 58% 47%)', width: 220, height: 260 },
  ...
  { x: 204, y: 70, rotate: 28, clip: 'polygon(58% 47%, 100% 49%, 100% 100%, 66% 100%)', width: 230, height: 270 },
